...
import 'package:lepton_sci_web/main_screens/live_classes.dart';
import 'package:lepton_sci_web/main_screens/rcorded_classes.dart';
...
class AdminPage extends StatefulWidget {
  String? facultyController,passwordController,recordedTitleController,recordedSubTitleController,
      recordedDurationController,recordedFeesController,recordedFacultyNameController ,recordedVideoNumberController,
      recordedCourseIdController,liveTitleController,liveSubTitleController, liveDurationController,liveFeesController,
      liveFacultyNameController,liveVideoNumberController, liveCourseIdController,
      hybridTitleController,hybridSubTitleController, hybridDurationController,hybridFeesController,hybridFacultyNameController,
      hybridVideoNumberController, hybridCourseIdController;
  AdminPage ({Key? key, this.facultyController,this.passwordController,this.recordedTitleController,
    this.recordedSubTitleController,this.recordedDurationController,this.recordedFeesController,this.recordedFacultyNameController,
    this.recordedVideoNumberController,this.recordedCourseIdController,this.liveTitleController,
    this.liveSubTitleController,this.liveDurationController,this.liveFeesController,
    this.liveFacultyNameController,this.liveVideoNumberController,this.liveCourseIdController,
    this.hybridTitleController,this.hybridSubTitleController,this.hybridDurationController,
    this.hybridFeesController,this.hybridFacultyNameController,this.hybridVideoNumberController,
...
class _AdminPageState extends State<AdminPage> {
  ...
  CollectionReference refRecorded = FirebaseFirestore.instance.collection("RecordedCourseList");
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                    ...
                    Container(
                      child:
                      Image.asset("assets/images/sout.png",height: 50,width:50),))
              ],
            ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Upload Recorded Class",style: TextStyle(
                        color: Colors.white,
                        fontSize: 25,
                        fontWeight: FontWeight.bold
                    ),),
                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            child:
                          Container(
                            child: const Text("Select Recorded Class ",style: TextStyle(
                                  ...
                                  SizedBox(
                                      ...
                                      child: LiquidCircularProgressIndicator(
                                        borderColor: Colors.red,
                                          ...
                                          center: Text("$progress%",style:  TextStyle(fontSize: screenSize.width*1/90))
                                      )
                                  ),
                                  SizedBox(height: 20,),
                                ],
                          ...
                          MaterialButton(
                            onPressed: () {
                              //uploadFile();
                              refRecorded.doc(recordedCourseIdController.text).set({
                                ...
                                'FacultyName': recordedFacultyNameController.text,
                                'ImageUrl': imageUrl,
                                ...
                                Navigator.pushReplacement(
                                  context, MaterialPageRoute(
                                   builder: (_) => const RecordedClasses()));
                              });
                            },
                            child: const Text(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Upload Live Class",style: TextStyle(
                        color: Colors.white,
                        fontSize: 25,
                        fontWeight: FontWeight.bold
                    ),),
                          ...
                          MaterialButton(
                            onPressed: () {
                              ...
                              refLive.doc(liveCourseIdController.text).set({
                                ...
                                'CourseSubTitle': liveSubTitleController.text,
                                'CourseDuration': liveDurationController.text,
                                'CourseFee': liveFeesController.text,
                                'FacultyName': liveFacultyNameController.text,
                                'ImageUrl': imageUrl,
              ...
              Container(
                ...
                child: Column(
                  children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                MaterialButton(
                                  onPressed: () {
                                    //uploadFile();
                                    refHybrid.doc(hybridCourseIdController.text).set({
                                      'CourseTitle': hybridTitleController.text,
                                      'CourseSubTitle': hybridSubTitleController.text,
                                      'CourseDuration': hybridDurationController.text,
                                      'CourseFee': hybridFeesController.text,
                                      'FacultyName': hybridFacultyNameController.text,
                                      'ImageUrl': imageUrl,
                                      'CourseID': hybridCourseIdController.text,
                                      "Date": dateText,
                                      "Time": timeText
                    ...
                    SizedBox(height:20),
                    const Text("Faculty Control Panel",style: TextStyle(
                        color: Colors.red,
                        fontSize: 25,
                        fontWeight: FontWeight.bold
                    ),),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          const SizedBox(height: 10,),
                          const Text("Add Faculty ",style: TextStyle(
                              color: Colors.black87,
                              fontSize: 15,
                              fontWeight: FontWeight.bold
                          ),),
