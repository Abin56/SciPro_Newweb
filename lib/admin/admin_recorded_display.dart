...
class AdminRecordedDisplay extends StatefulWidget {
  String? 
  facultyController,passwordController,recordedTitleController,recordedSubTitleController,
  ...
  AdminRecordedDisplay({Key? key, this.facultyController,this.passwordController,this.recordedTitleController,
...
class _AdminRecordedDisplayState extends State<AdminRecordedDisplay> {
  ...
  CollectionReference refRecorded = FirebaseFirestore.instance.collection("RecordedCourseDetails");
  ...
  void getCourseID() async {
    User? user = FirebaseAuth.instance.currentUser;
    var vari = await FirebaseFirestore.instance.collection("RecordedCourses").doc(arCourseID).get();
    setState(() {
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(_courseID,style: TextStyle(fontSize: 20,color: Colors.red),)
