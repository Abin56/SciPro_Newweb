...
class UploadLive extends StatefulWidget {
  ...
  UploadLive ({Key? key, this.facultyController,this.passwordController,this.recordedTitleController,
...
class _UploadLiveState extends State<UploadLive> {
  ...
  CollectionReference refLive = FirebaseFirestore.instance.collection("LiveCoursesList");
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Upload LiveCourse",style: TextStyle(
                            color: Colors.white,
                            fontSize: 25,
                            fontWeight: FontWeight.bold
                        ),),
                          ...
                          child: Column(
                            children: [
                              ...
                              MaterialButton(
                                onPressed: () {
                                  //uploadFile();
                                  refLive.doc(recordedCourseIdController.text).set({
