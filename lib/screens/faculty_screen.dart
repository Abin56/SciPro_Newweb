...
class _FacultyScreenState extends State<FacultyScreen> {
  ...
  List<Widget> generateCoursesImagesTiles() {
    return courseImagesList.map((element) =>
        ClipRRect(
          child: Image.asset(element,
            fit: BoxFit.cover,
          ),
      ...
      Column(
        ...
        children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.asset("assets/SCIPRO.png", width: 100, height:120,),
                            const Text("The Science Professional",style: TextStyle(color: Colors.black,fontSize: 15,
                      ...
                      Container(
                        ...
                        child:  Row(
                          children: [
                            const Text("Hi ",style: TextStyle(color: Colors.red,fontSize: 20,
                                fontWeight: FontWeight.bold),),
                            Text(nameController,style: const TextStyle(color: Colors.red,fontSize: 20,
                                fontWeight: FontWeight.bold),),
          ...
          Row(
              ...
              children:const [
                Text("Our Faculties", style: TextStyle(
                    fontSize: 20,
                    color: Colors.red,
                    fontWeight: FontWeight.bold),),]),
          Container(
            ...
            child: Stack(
              children: [
                CarouselSlider(
                    items: generateImagesTiles(), options: CarouselOptions(
                ...
                const AspectRatio(aspectRatio: 18 / 8,
                ),
              ],),),
          Column(
            ...
            children: [
              ...
              Text('${subtitles[_current]}', style: const TextStyle(
                fontSize: 20.0,
                fontWeight: FontWeight.bold,
                //backgroundColor: Colors.black45,
                color: Colors.black,
